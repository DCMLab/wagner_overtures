...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the “Vorspiel” of *Tristan und Isolde* has the following files:
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/wagner_overtures/issues>`__ and feel free to fork and submit pull requests.
